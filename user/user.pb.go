...
func (x *CreateUserRequest) GetManagerId() string {
	if x != nil {
		return x.ManagerId
	}
	return ""
...
func (x *UpdateUserRequest) GetManagerId() string {
	if x != nil {
		return x.ManagerId
	}
	return ""
...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\"\xe9\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x06active\x18\t \x01(\bR\x06active\"\x90\x01\n" +
	...
	"\n" +
	"manager_id\x18\x05 \x01(\tR\tmanagerId\"4\n" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role\x12\x1d\n" +
	"\n" +
	"manager_id\x18\x05 \x01(\tR\tmanagerId\x12\x16\n" +
	"\x06active\x18\x06 \x01(\bR\x06active\"4\n" +
	...
	"\tpage_size\x18\x04 \x01(\x05R\bpageSize2\xc6\x02\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB$Z\"internal-support-system/proto/userb\x06proto3"
