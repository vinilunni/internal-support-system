...
const (
	...
	AssetService_GetAssetsByUser_FullMethodName = "/asset.AssetService/GetAssetsByUser"
)
...
func (c *assetServiceClient) GetAssetsByUser(ctx context.Context, in *GetAssetsByUserRequest, opts ...grpc.CallOption) (*GetAssetsByUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssetService_GetAssetsByUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetService_GetAssetsByUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAssetsByUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AssetServiceServer).GetAssetsByUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AssetService_GetAssetsByUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AssetServiceServer).GetAssetsByUser(ctx, req.(*GetAssetsByUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AssetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AssetService_GetAssetsByUser_Handler,
		},
	},
